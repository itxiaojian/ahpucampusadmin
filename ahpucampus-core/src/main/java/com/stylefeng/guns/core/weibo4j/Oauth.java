...
import com.stylefeng.guns.core.weibo4j.http.BASE64Encoder;
...
public class Oauth extends Weibo {
	...
	public String parseSignedRequest(String signed_request) throws IOException,
		...
		SecretKey key = new SecretKeySpec(WeiboConfig.client_SERCRET.getBytes(), "hmacSHA256");
		Mac m;
	...
	public AccessToken getAccessTokenByCode(String code) throws WeiboException {
		return new AccessToken(client.post(
				...
				new PostParameter[] {
						...
						new PostParameter("redirect_uri", WeiboConfig.redirect_URI) }, false, null));
	}

	public String authorize(String response_type) throws WeiboException {
		return WeiboConfig.authorizeURL.trim() + "?client_id="
				+ WeiboConfig.client_ID.trim() + "&redirect_uri="
				+ WeiboConfig.redirect_URI.trim()
